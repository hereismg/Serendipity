...
execute as @e[tag=sdpt-event_system-is_attack] if function sdpt:interaction_event/is_attack/run run function #minecraft:events/is_attack
execute as @e[tag=sdpt-event_system-is_interaction] if function sdpt:interaction_event/is_interaction/run run function #minecraft:events/is_interaction 